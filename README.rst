...
.. |buildenv-qt5-centos7-slicer-5.4| image:: https://img.shields.io/docker/image-size/slicer/buildenv-qt5-centos7/slicer-5.4
  :target: https://hub.docker.com/layers/slicer/buildenv-qt5-centos7/slicer-5.4/images/sha256-UNKNOWN

slicer/buildenv-qt5-centos7:slicer-5.4
  |buildenv-qt5-centos7-slicer-5.4| Build environment based on Centos7 and including Qt 5.15.4, GCC 7, CMake 3.22.1
